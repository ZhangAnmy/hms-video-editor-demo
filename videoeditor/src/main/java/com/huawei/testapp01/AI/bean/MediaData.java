...
package com.huawei.testapp01.AI.bean;
...
public class MediaData implements Parcelable {
    ...
    public HVECut getCut() {
        if (Float.compare(this.glLeftBottomX, 0.0f) == 0 && Float.compare(this.glLeftBottomY, 0.0f) == 0
                ...
                && Float.compare(this.scaleX, 0.0f) == 0 && Float.compare(this.scaleY, 0.0f) == 0) {
            return null;
        } else {
            return new HVECut(glLeftBottomX, glLeftBottomY, glRightTopX, glRightTopY, scaleX,scaleY);
        }
    }
