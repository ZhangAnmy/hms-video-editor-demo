...
import com.huawei.testapp01.utils.FileUtil;
import com.huawei.testapp01.utils.ToastUtils;
...
public class ViewFileActivity extends BaseActivity {
    ...
    private String mVideoOutputPath = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES)
            + File.separator + LOCAL_VIDEO_SAVE_PATH + File.separator
            + TimeUtils.formatTimeByUS(System.currentTimeMillis(), LOCAL_VIDEO_SAVE_TIME) + ".mp4";

    private String mPhotoOutputPath = Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator
            + "DCIM" + File.separator + "Camera" + File.separator + LOCAL_VIDEO_SAVE_PATH + File.separator
            + TimeUtils.formatTimeByUS(System.currentTimeMillis(), LOCAL_VIDEO_SAVE_TIME) + ".jpg";
