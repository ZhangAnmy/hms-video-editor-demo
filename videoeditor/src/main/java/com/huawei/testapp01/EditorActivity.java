...
import com.huawei.testapp01.adpter.DraftAdapter;
import com.huawei.testapp01.utils.PermissionUtils;
...
//        MediaApplication.getInstance().setApiKey(config.getString("client/api_key"));
        MediaApplication.getInstance().setApiKey("CgB6e3x9lt+luEGbAnu4YLu7hMd+RZCFo43Mzoi3brOTdv2B35L/TNqJHM4/9zv81s9ET2CDWKFfkbj7sU4Z7GbE");
    ...
    private void initEvent() {
        ...
        draftAdapter.setSelectedListener(new DraftAdapter.OnStyleSelectedListener() {
            ...
            public void onStyleSelected(int position) {
                ...
                MediaApplication.getInstance()
                        .launchEditorActivity(EditorActivity.this,
        ...
        draftAdapter.setLongSelectedListener(new DraftAdapter.OnStyleLongSelectedListener() {
            ...
            public void onStyleLongSelected(View v, int position) {
                EditorActivity.this.position = position;
                PopupMenu popup = new PopupMenu(EditorActivity.this, v);
        ...
        mSetting.setOnClickListener(v -> this.startActivity(new Intent(EditorActivity.this, SettingActivity.class)));
    }
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.delete:
                String draftId = draftInfos.get(EditorActivity.this.position).getDraftId();
